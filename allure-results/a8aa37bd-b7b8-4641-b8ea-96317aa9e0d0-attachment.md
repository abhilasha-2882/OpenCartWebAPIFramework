    ...
    - generic [ref=e30]:
      ...
      - generic [ref=e36]:
        ...
        - button "" [ref=e39] [cursor=pointer]:
          - generic [ref=e40]: 
      - generic [ref=e42]:
        - button " 15 item(s) - $30,000.00" [ref=e43] [cursor=pointer]:
          - generic [ref=e44]:
            - generic [ref=e45]: 
            - text: 15 item(s) - $30,000.00
        - text:   
  - navigation [ref=e47]:
    - generic: 
    - list [ref=e49]:
...
> 44 |   expect(successheader).toBe('Success: You have added MacBook Pro to your shopping cart!');
     |                         ^ Error: expect(received).toBe(expected) // Object.is equality
  45 | });
  46 |  
```