...
- Name: productPage.spec.ts >> verify product Information/Data with -macbook-MacBook Pro
- Location: tests\productPage.spec.ts:24:1
...
```ts
  ...
  32 |   expect.soft(actualproductInfoMap.get('Reward Points')).toBe('800');
  33 |   expect.soft(actualproductInfoMap.get('productPrice')).toBe('$2,000.00');
> 34 |   expect.soft(actualproductInfoMap.get('xxTaxPrice')).toBe('$2,000.00');
     |                                                       ^ Error: expect(received).toBe(expected) // Object.is equality
  35 |   
  36 | });
  37 |  }
