...
- Name: loginpagefix.spec.ts >> invalid login test with excel data -pwbatchtest@open.com-undefined
- Location: tests\loginpagefix.spec.ts:63:5
        ...
        - generic [ref=e85]:
          ...
          - generic [ref=e89]:
            - generic [ref=e90]:
              ...
              - textbox "E-Mail Address" [active] [ref=e92]: pwbatchtest@open.com
            - generic [ref=e93]:
...
```ts
  ...
  17 |  this.loginBtn=page.getByRole('button',{name:'Login'});
  18 |  this.forgottenPasswordLink=page.getByRole('link',{name:'Forgotten Password'}).first();
  19 |  this.logo=page.getByAltText('naveenopencart');
  20 |  this.loginErrorMessage=page.locator('.alert.alert-danger.alert-dismissible');
  21 | 
  22 | }
  23 | 
  24 | //public page action(methods)/behaviour
