...
Call log:
  - waiting for getByRole('heading', { name: 'Your Account Has Been Created!', level: 1 })
...
> 61 |    console.log(this.registerpageheading.innerText())
     |                                         ^ Error: locator.innerText: Test ended.
